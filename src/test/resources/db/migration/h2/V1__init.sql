...
DROP TABLE IF EXISTS staff_points_log;
DROP TABLE IF EXISTS staff_points_account;
...
CREATE TABLE care_task_review (
  ...
  reviewer_type VARCHAR(32) DEFAULT NULL,
...
CREATE TABLE room (
  ...
  room_qr_code VARCHAR(128) DEFAULT NULL,
  created_by BIGINT DEFAULT NULL,
  create_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  update_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  is_deleted TINYINT NOT NULL DEFAULT 0
...
CREATE TABLE elder_change_log (
  ...
  before_value VARCHAR(128) DEFAULT NULL,
  after_value VARCHAR(128) DEFAULT NULL,
...
CREATE TABLE staff_profile (
  ...
  qualification_level VARCHAR(32) DEFAULT NULL,
...
CREATE TABLE staff_training_record (
  ...
  training_type VARCHAR(32) DEFAULT NULL,
...
CREATE TABLE staff_points_account (
  ...
  total_deducted INT NOT NULL DEFAULT 0,
  status TINYINT NOT NULL DEFAULT 1,
  create_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  update_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  is_deleted TINYINT NOT NULL DEFAULT 0
...
CREATE TABLE product (
  ...
  business_domain VARCHAR(16) NOT NULL DEFAULT 'BOTH',
  item_type VARCHAR(16) NOT NULL DEFAULT 'CONSUMABLE',
  mall_enabled TINYINT NOT NULL DEFAULT 1,
...
CREATE TABLE order_item (
  ...
  product_name_snapshot VARCHAR(128) DEFAULT NULL,
