-- Backfill survey tables for environments baselined above V5.
-- Some legacy databases used baseline-version=11 and skipped V5__m7_survey.sql.
-- This migration guarantees survey tables exist before survey module queries.
...
-- Keep tenant_id consistent in legacy rows.
