...
public class CrmContractServiceImpl implements CrmContractService {
  ...
  private static final String CHANGE_NONE = ContractChangeStatus.NONE.code();
  private static final String CHANGE_IN_PROGRESS = ContractChangeStatus.IN_PROGRESS.code();
  private static final String CHANGE_PENDING_APPROVAL = ContractChangeStatus.PENDING_APPROVAL.code();
  private static final String CHANGE_APPROVED = ContractChangeStatus.APPROVED.code();
  private static final String CHANGE_REJECTED = ContractChangeStatus.REJECTED.code();
