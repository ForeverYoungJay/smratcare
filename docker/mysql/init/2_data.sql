...
VALUES (600, 1, 401, 201, 101, 500, DATE_ADD(CURRENT_TIMESTAMP, INTERVAL -2 MINUTE), 'QR2', 1, 0);
...
VALUES (8001, 1, 6003, 'BATCH-MILK-01', 10, 2.50, DATE_ADD(CURRENT_DATE, INTERVAL 30 DAY), 'WH-A1');
