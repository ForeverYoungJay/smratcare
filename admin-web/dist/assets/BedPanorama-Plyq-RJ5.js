import{u as cc,r as ct,w as Hi,J as uc,e1 as et,ed as mt,eZ as ge,f as Ge,E as ms,v as wh,eY as O,d_ as Bi,e2 as Xe,aL as st,eb as ki,C as ke,f5 as ld,aq as cd,ar as ud,f1 as Rh,e0 as dn,e9 as Qs,eW as Fn,e_ as di,ag as yn,dQ as _s}from"./auth-oL2NLDlK.js";import{d as hd,u as fd}from"./admin-B2jBLqw8.js";import{P as dd}from"./PageContainer-Ct1sr5pK.js";import{_ as hc}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{g as pd,a as md}from"./bed-i6M5xURc.js";import{g as _d}from"./elder-C6mEvGsE.js";import{u as gd}from"./useLiveSyncRefresh-BJ6Bm0IY.js";import{u as vd}from"./user-PsUHzQhy.js";import"./request-CQv2nBJc.js";import"./pageAccess-BdoNgTes.js";const xd={class:"animated-number"},Md=cc({__name:"AnimatedMetricNumber",props:{value:{},duration:{default:900},decimals:{default:0},prefix:{default:""},suffix:{default:""}},setup(r){const e=r,t=ct(e.value);let n=0;function i(){n&&(cancelAnimationFrame(n),n=0)}function s(o){i();const l=t.value,c=o-l;if(!c)return;const u=performance.now(),f=h=>{const d=Math.min((h-u)/e.duration,1),_=1-Math.pow(1-d,3);if(t.value=l+c*_,d<1){n=requestAnimationFrame(f);return}t.value=o,n=0};n=requestAnimationFrame(f)}Hi(()=>e.value,o=>{s(o)},{immediate:!0}),uc(()=>{i()});const a=Ge(()=>{const o=t.value.toFixed(e.decimals);return`${e.prefix}${o}${e.suffix}`});return(o,l)=>(et(),mt("span",xd,ge(a.value),1))}}),Sd=hc(Md,[["__scopeId","data-v-9090121e"]]);/**
 * @license
