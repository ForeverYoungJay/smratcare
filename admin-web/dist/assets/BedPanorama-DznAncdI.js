import{u as dc,r as at,w as Ri,J as pc,e1 as pt,ed as Rt,eZ as ve,f as He,E as Ss,v as Ph,eY as H,d_ as gr,e2 as Je,aL as ht,eb as Is,C as We,e_ as hd,aq as fd,ar as dd,f2 as Dh,ag as si,eW as Ei,e$ as Ti,e0 as An,e9 as ys,dQ as bs}from"./auth-B_z5DHJV.js";import{d as pd,u as md}from"./admin-Bzk_lqos.js";import{P as _d}from"./PageContainer-CXliJSGu.js";import{_ as mc}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{g as gd,a as vd}from"./bed-_QsPrmZT.js";import{g as xd}from"./elder-5mIP5TN5.js";import{u as Md}from"./useLiveSyncRefresh-BJ87t1CJ.js";import{u as Sd}from"./user-DDfrwhj4.js";import"./request-B8-y9hm1.js";import"./pageAccess-DcvrcATa.js";const yd={class:"animated-number"},bd=dc({__name:"AnimatedMetricNumber",props:{value:{},duration:{default:900},decimals:{default:0},prefix:{default:""},suffix:{default:""}},setup(r){const e=r,t=at(e.value);let n=0;function i(){n&&(cancelAnimationFrame(n),n=0)}function s(o){i();const l=t.value,c=o-l;if(!c)return;const u=performance.now(),f=h=>{const p=Math.min((h-u)/e.duration,1),g=1-Math.pow(1-p,3);if(t.value=l+c*g,p<1){n=requestAnimationFrame(f);return}t.value=o,n=0};n=requestAnimationFrame(f)}Ri(()=>e.value,o=>{s(o)},{immediate:!0}),pc(()=>{i()});const a=He(()=>{const o=t.value.toFixed(e.decimals);return`${e.prefix}${o}${e.suffix}`});return(o,l)=>(pt(),Rt("span",yd,ve(a.value),1))}}),Ed=mc(bd,[["__scopeId","data-v-9090121e"]]);/**
 * @license
