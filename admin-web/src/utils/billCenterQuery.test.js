...
import { buildBillCenterRouteQuery, buildBillCenterRouteSignature, parseBillCenterRouteState } from './billCenterQuery';
describe('billCenterQuery utils', () => {
    ...
    it('builds stable signature from managed route keys', () => {
        ...
        expect(signature).toBe('billKeyword:A|billMonth:|billPageNo:1|billPageSize:10|billPayMethod:|billScene:');
    });
});
