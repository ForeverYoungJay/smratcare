export interface HealthExportColumn<T> {
  key: string
  title: string
  value: (item: T) => string | number
}

export function mapHealthExportRows<T>(items: T[], columns: HealthExportColumn<T>[]) {
...
export const medicationRegistrationExportColumns: HealthExportColumn<any>[] = [
...
export const inspectionExportColumns: HealthExportColumn<any>[] = [
  { key: 'elderName', title: '老人姓名', value: (item) => item.elderName || '' },
...
export const nursingLogExportColumns: HealthExportColumn<any>[] = [
  { key: 'elderName', title: '老人姓名', value: (item) => item.elderName || '' },
...
export const drugDictionaryExportColumns: HealthExportColumn<any>[] = [
...
export const drugDepositExportColumns: HealthExportColumn<any>[] = [
...
export const medicationSettingExportColumns: HealthExportColumn<any>[] = [
  { key: 'elderName', title: '老人', value: (item) => item.elderName || '' },
  { key: 'drugName', title: '药品', value: (item) => item.drugName || '' },
...
export const medicationRemainingExportColumns: HealthExportColumn<any>[] = [
  { key: 'elderName', title: '老人', value: (item) => item.elderName || '' },
  { key: 'drugName', title: '药品', value: (item) => item.drugName || '' },
...
export const archiveExportColumns: HealthExportColumn<any>[] = [
  { key: 'elderName', title: '老人', value: (item) => item.elderName || '' },
...
export const healthDataExportColumns: HealthExportColumn<any>[] = [
  { key: 'elderName', title: '老人', value: (item) => item.elderName || '' },
