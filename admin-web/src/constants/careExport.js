export function mapCareExportRows(items, columns) {
...
export const careTemplateExportColumns = [
...
export const careExceptionExportColumns = [
...
export const careAuditExportColumns = [
    { key: 'elderName', title: '老人', value: (item) => item.elderName || '' },
    { key: 'roomNo', title: '房间', value: (item) => item.roomNo || '' },
    { key: 'taskName', title: '任务', value: (item) => item.taskName || '' },
...
export const careTodayTaskExportColumns = [
    { key: 'elderName', title: '老人', value: (item) => item.elderName || '' },
    { key: 'roomNo', title: '房间', value: (item) => item.roomNo || '' },
    { key: 'taskName', title: '任务', value: (item) => item.taskName || '' },
    { key: 'planTime', title: '计划时间', value: (item) => item.planTime || '' },
...
export const careTodayLogExportColumns = [
