...
const getAdmissionFeeAuditPage = vi.hoisted(() => vi.fn().mockResolvedValue({ list: [], total: 0, pageNo: 1, pageSize: 10 }))
const reviewAdmissionFeeAudit = vi.hoisted(() => vi.fn().mockResolvedValue(null))
