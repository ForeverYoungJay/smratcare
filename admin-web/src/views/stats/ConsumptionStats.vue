<template>
  <PageContainer title="消费统计" subTitle="账单与商城消费分析">
    ...
    <a-row :gutter="16" style="margin-top: 16px;">
      ...
      <a-col :span="8">
        <a-card class="card-elevated" :bordered="false">
          <a-statistic title="消费合计" :value="totalConsumption" :precision="2" />
        </a-card>
      </a-col>
    </a-row>
...
const totalConsumption = computed(() => (stats.totalBillConsumption || 0) + (stats.totalStoreConsumption || 0))
