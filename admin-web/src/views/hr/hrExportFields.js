export const HR_EXPENSE_EXPORT_FIELDS = [
...
export const HR_APPROVAL_EXPORT_FIELDS = [
    { key: 'title', label: '标题' },
...
export const HR_ATTENDANCE_EXPORT_FIELDS = [
...
export function mapByDict(rows, dict) {
    return rows.map((row) => {
        const mapped = {};
        dict.forEach((item) => {
